...
namespace XecMe
{
    ...
    static class Host
    {
        ...
        {
            Console.WriteLine("Usage: WinSvc <command> [<options>]");
            Console.WriteLine();
            ...
            Console.WriteLine();
            Console.WriteLine("\t-p=<Path of the application> -c<Path of batch config> [-v]");
            Console.WriteLine("\tThis is a console mode and the application will run as Console application");
            Console.WriteLine();
            ...
            Console.WriteLine();
            Console.WriteLine("\t/u -n=<Name of the Service/Batch> [-v]");
            Console.WriteLine("\tUninstalls the Windows Service with the given name.");
            Console.WriteLine();
        }
