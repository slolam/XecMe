...
namespace XecMe.Core.SecureMail
{
    ...
    public class SecureAttachment
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:XecMe.Core.SecureMail.SecureAttachment"></see> class with the specified content. 
        /// </summary>
        ...
        /// </summary>
        /// <param name="fileName">A <see cref="T:System.String"></see> that contains a file path to use to create this attachment.</param>
        /// <param name="contentType">A <see cref="T:XecMe.Core.SecureMail.SecureContentType"></see> object which describes the attachment's content type.</param>
