...
namespace XecMe.Core.Configuration
{
    public class EventTaskRunnerElement : TaskRunnerElement
    {
        ...
        [ConfigurationProperty(EVENT_NAME, IsRequired = true)]
        public string EventName
        {
            get { return (string)base[EVENT_NAME]; }
            set { base[EVENT_NAME] = value; }
        }

        [ConfigurationProperty(THREAD_OPTION, DefaultValue = ThreadOption.Background)]
        ...
        {
            return new EventTaskRunner(this.GetTaskType(), InternalParameters(), EventName, this.ThreadOption);
        }
    }
}
